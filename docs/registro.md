...
2. El sistema identificará si se trata de un **"Solicitante Nuevo"** o una **"Solicitud Nueva"**. Lo que determinará el contenido del formulario que aparezca para registro, de acuerdo a lo siguiente:
...
3. Luego de ingresar los datos correspondientes, la solicitud quedará registrada luego de activar el botón **"Registrar"**.
